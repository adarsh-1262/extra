...
class Sponser(db.Model):
    ...
    campaigns=db.relationship("Campaign",backref="sponsered",cascade='all, delete-orphan')
...
class Influencer(db.Model):
    ...
    flagged_status=db.Column(db.Integer(),default=0)
    Ads_request=db.relationship("Ad_request",backref="influencer",cascade='all, delete-orphan')
...
class Campaign(db.Model):
    ...
    sponser_ads=db.relationship("Ad_request",backref="c_ads")
