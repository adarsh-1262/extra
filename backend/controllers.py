...
def admin_login():
    if request.method=="POST":
        ...
        if username=="Preeti Maurya" and password=="Rmsdpsps1004@":
...
def sponser_dashboard(sponser_id):
    ...
    newad_request= Ad_request.query.filter_by(send_by=1, ad_request_status="pending").all()
    nego_ads=Ad_request.query.filter_by(nego=1,send_by=0).all()
...
def update_sponser_profile(sponser_id):
    if request.method=="POST":
        name=request.method.get("sponser_name")
        industry=request.method.get("industry")
        budget=request.method.get("budget")
...
def add_request(sponser_id):
    if request.method=="POST":
        ...
        if existing_request:
            ...
            new_request=Ad_request(send_by=0,msg=msg,requirements=requirements,payment_amount=payment_amount,influencer_id=influencer_id,campaign_id=campaign_id)
...
def accept_nego(sponser_id):
     if request.method=="POST":
        ...
        active_campaigns = Campaign.query.filter_by(sponser_id=sponser_id, campaign_flagged_status=0,campaign_status="accepted").all()
        newad_request= Ad_request.query.filter_by(send_by=1, ad_request_status="pending").all()
        nego_ads=Ad_request.query.filter_by(nego=1,send_by=1).all()
        return render_template("sponser_dashboard.html", sponser=sponser, campaigns=active_campaigns, newads=newad_request,sponser_id=sponser_id,name=sponser.sponser_company_name,nego_ads=nego_ads)
...
def negotiate_request(sponser_id):
    if request.method=="POST":
        msg=request.form.get("msg")
        amount=request.form.get("payment_ammount")
        ad_id=request.form.get("ad_id")
        nego_ads=Ad_request.query.filter_by(id=ad_id,send_by=1).first()
        nego_ads.nego=1
        nego_ads.msg=msg
        nego_ads.payment_amount=payment_amount
        db.session.commit()
        sponser = Sponser.query.get_or_404(sponser_id)
        active_campaigns = Campaign.query.filter_by(sponser_id=sponser_id, campaign_flagged_status=0,campaign_status="accepted").all()
        newad_request= Ad_request.query.filter_by(send_by=1, ad_request_status="pending").all()
...
def influencer_dashboard(influencer_id):
    ...
    Requested_ads=Ad_request.query.filter_by(send_by=1,influencer_id=influencer_id,nego=0).all()
...
def in_negotiate_request(influencer_id):
    if request.method=="POST":
        ...
        accepted_campaigns = Campaign.query.join(Campaign.sponser_ads).filter(Ad_request.ad_request_status == "accepted",Ad_request.influencer_id == influencer_id).all()
        Requested_ads=Ad_request.query.filter_by(send_by=1,influencer_id=influencer_id,nego=0).all()
        new_ad_requests=Ad_request.query.filter_by(influencer_id=influencer_id,ad_request_status="pending",send_by=0).all()
        nego_requests=Ad_request.query.filter_by(influencer_id=influencer_id,ad_request_status="pending",send_by=1,nego=1).all()
        return render_template("influencer_dashboard.html",name=influencer.influencer_name,influencer_id=influencer_id,campaigns=accepted_campaigns,newads=new_ad_requests,requested_ads=Requested_ads,nego_requests=nego_requests,i_user=influencer)
...
def in_reject_request(influencer_id):
    if request.method=="POST":
        ...
        new_ad_requests=Ad_request.query.filter_by(influencer_id=influencer_id,ad_request_status="pending",send_by=0).all()
        nego_requests=Ad_request.query.filter_by(influencer_id=influencer_id,ad_request_status="pending",send_by=1,nego=1).all()
        return render_template("influencer_dashboard.html",i_user=influencer,name=influencer.influencer_name,influencer_id=influencer_id,campaigns=accepted_campaigns,newads=new_ad_requests,requested_ads=Requested_ads,nego_requests=nego_requests)
...
def influencer_add_request(influencer_id):
     if request.method=="POST":
        ...
        if existing_request:
            ...
            new_request=Ad_request(send_by=1,msg=msg,requirements=requirements,payment_amount=payment_amount,influencer_id=influencer_id,campaign_id=campaign_id)
            db.session.add(new_request)
            db.session.commit()
            influencer = Influencer.query.get_or_404(influencer_id)
            accepted_campaigns = Campaign.query.join(Campaign.sponser_ads).filter(Ad_request.ad_request_status == "accepted",Ad_request.influencer_id == influencer_id).all()
...
def delete_influencer_ad_request(influencer_id):
    if request.method=="POST":
        ...
        new_ad_requests=Ad_request.query.filter_by(influencer_id=influencer_id,ad_request_status="pending",send_by=0).all()
        nego_requests=Ad_request.query.filter_by(influencer_id=influencer_id,ad_request_status="pending",send_by=1,nego=1).all()
        return render_template("influencer_dashboard.html",name=influencer.influencer_name,influencer_id=influencer_id,campaigns=accepted_campaigns,newads=new_ad_requests,requested_ads=Requested_ads,nego_requests=nego_requests,msg=msg)
...
def update_influencer_profile(influencer_id):
    if request.method=="POST":
        ...
        new_ad_requests=Ad_request.query.filter_by(influencer_id=influencer_id,ad_request_status="pending",send_by=0).all()
        nego_requests=Ad_request.query.filter_by(influencer_id=influencer_id,ad_request_status="pending",send_by=1,nego=1).all()
        return render_template("influencer_dashboard.html",i_user=influencer,name=influencer.influencer_name,influencer_id=influencer_id,campaigns=accepted_campaigns,newads=new_ad_requests,requested_ads=Requested_ads,nego_requests=nego_requests,msg=msg)
